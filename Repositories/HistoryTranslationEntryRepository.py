...
from Models.HistoryTranslation import HistoryTranslationEntry
...
class HistoryTranslationEntryRepository:
    ...
    def add_translated_entry(self, history_translated_entry: HistoryTranslationEntry):
    ...
    def update_translated_entry(self, entry_id: str, history_translated_entry: HistoryTranslationEntry):
